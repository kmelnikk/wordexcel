...
namespace PaymentsExample
{
    ...
    {
        private PaymentsBaseEntities1 _context = new PaymentsBaseEntities1();
        public MainWindow()
        {
            InitializeComponent();
        ...
        private void BtnExportToExcel_Click(object sender, RoutedEventArgs e)
        {
            ...
            for (int i=0; i < allUsers.Count();i++)
            {
                ...
                {
                    Excel.Range headerRange = worksheet.Range[worksheet.Cells[i+1][startRowIndex], worksheet.Cells[5][startRowIndex]];
                    headerRange.Merge();
        ...
        private void BtnExportToWord_Click(object sender, RoutedEventArgs e)
        {
            ...
            foreach (var user in allUsers)
            {
                ...
                if (maxPayment != null)
                {
                    ...
                    //maxPaymentParagraph.set_Style("Строгий");
                ...
                if (maxPayment != null)
                {
                    ...
                    //minPaymentParagraph.set_Style("Строгий");
            ...
            application.Visible = true;
            document.SaveAs2(@"C:\Payments.docx");
            document.SaveAs2(@"C:\Payments.pdf", Word.WdExportFormat.wdExportFormatPDF);
        }
    }
}
